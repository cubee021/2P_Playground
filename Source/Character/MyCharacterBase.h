...
#include "Project2/Interface/MyCharacterItemInterface.h"
#include "Project2/Interface/MyCharacterWidgetInterface.h"
...
protected:
	...
	* Combo punch, combo melee attack section */
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Attack, Meta = (AllowPrivateAccess = "true"))
		TObjectPtr<class UMyComboAttackData> ComboAttackData;
	...
	void ComboAttackBegin(class UAnimMontage* InMontage);
	void ComboActionEnd(class UAnimMontage* TargetMontage, bool IsProperlyEnded);

	/** Delay time between current combo action and next combo action */
	void SetComboPunchCheckTimer();
	void SetComboMeleeCheckTimer();

	/** Check if next combo action remaining */
	void ComboPunchCheck();
	void ComboMeleeCheck();
